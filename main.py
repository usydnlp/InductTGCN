...
parser.add_argument('--shuffle_seed',type = int, default = None, help="xxx")
parser.add_argument('--hidden_dim',type = int, default = 200, help="xxx")
parser.add_argument('--dropout',type = float, default = 0.5, help="xxx")
parser.add_argument('--learning_rate',type = float, default = 0.02, help="xxx")
parser.add_argument('--weight_decay',type = float, default = 0, help="xxx")
parser.add_argument('--early_stopping',type = int, default = 10, help="xxx")
parser.add_argument('--epochs',type = int, default = 200, help="xxx")
parser.add_argument('--multiple_times',type = int, default = 10, help="xxx")
parser.add_argument('--easy_copy',type = bool, default = True, help="xxx")
parser.add_argument('--edge_mask',type = float, default = 1.0, help="xxx")
